    ...
    series: [
      {
        ...
        data: ohlc,
        itemStyle: {
          color: settings["candlestick.increase_color"] ?? "#88bc50",
          color0: settings["candlestick.decrease_color"] ?? "#ed6e6e",
          borderColor: settings["candlestick.increase_color"] ?? "#88bc50",
          borderColor0: settings["candlestick.decrease_color"] ?? "#ed6e6e",
        },
      },
    ],
  } as EChartsCoreOption;
