...
import { getSunburstChartOption } from "./option";
...
export const SunburstChart = ({
  ...
  return <ResponsiveEChartsRenderer display="sunburst" option={option} />;
};

Object.assign(SunburstChart, SUNBURST_CHART_DEFINITION);
