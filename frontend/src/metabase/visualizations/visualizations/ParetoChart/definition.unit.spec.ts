...
import { PARETO_CHART_DEFINITION } from "./definition";

const isSensible = checkNotNull(PARETO_CHART_DEFINITION.isSensible);
...
describe("PARETO_CHART_DEFINITION", () => {
  describe("isSensible", () => {
  ...
  describe("checkRenderable", () => {
    it("should not throw for valid columns", () => {
      expect(() =>
        PARETO_CHART_DEFINITION.checkRenderable(
          [
            {
              card: createMockCard(),
