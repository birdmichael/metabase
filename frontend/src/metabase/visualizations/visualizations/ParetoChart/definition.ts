...
export const SETTINGS_DEFINITIONS: VisualizationSettingsDefinitions = {
  ...
  ...dimensionSetting("pareto.dimension", {
    getSection: () => t`Data`,
    get title() {
      return t`Dimension`;
    },
...
export const PARETO_CHART_DEFINITION: VisualizationDefinition = {
  getUiName: () => t`Pareto`,
  identifier: "pareto",
  iconName: "lineandbar",
  ...
  noun: t`pareto chart`,
  minSize: getMinSize("pareto"),
  defaultSize: getDefaultSize("pareto"),
  ...
  checkRenderable: (
    ...
    if (!settings["pareto.dimension"] || !settings["pareto.metric"]) {
