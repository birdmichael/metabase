...
export const SETTINGS_DEFINITIONS: VisualizationSettingsDefinitions = {
  ...
  ...dimensionSetting("rose.dimension", {
    getSection: () => t`Data`,
    get title() {
      return t`Dimension`;
    },
...
export const ROSE_CHART_DEFINITION: VisualizationDefinition = {
  ...
  noun: t`rose chart`,
  minSize: getMinSize("rose"),
  defaultSize: getDefaultSize("rose"),
  ...
  checkRenderable: (
    ...
    if (!settings["rose.dimension"] || !settings["rose.metric"]) {
